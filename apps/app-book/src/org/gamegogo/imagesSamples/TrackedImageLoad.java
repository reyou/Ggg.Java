...
public class TrackedImageLoad extends Applet implements Runnable {
    ...
    int current_img = 0;
    Thread motor;
    Image img[] = new Image[TrackedImageLoad.MAXIMAGES];
    String name[] = new String[TrackedImageLoad.MAXIMAGES];
    ...
    public void init() {
        ...
        StringTokenizer st = new StringTokenizer(getParameter("img"),
                "+");
        while (st.hasMoreTokens() && tracked <= TrackedImageLoad.MAXIMAGES) {
