package com.company;// Use an image with a button.
...
// Handle the action events for the hourglass button.
        btnHourglass.setOnAction(ae -> response.setText("Hourglass Pressed"));// Handle the action events for the analog clock button.
